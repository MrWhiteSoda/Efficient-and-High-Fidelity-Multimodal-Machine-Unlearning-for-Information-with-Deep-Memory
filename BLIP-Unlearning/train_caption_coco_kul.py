...
def main(args, config):
    ...
    train_dataset, val_dataset, test_dataset, unlearning_val_dataset, remain_dataset = create_dataset('caption_coco_kul', config)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./unlearning_configs/train_configs/caption_coco_kul.yaml')
    parser.add_argument('--output_dir', default='./output/Caption_coco_kul_resume')
