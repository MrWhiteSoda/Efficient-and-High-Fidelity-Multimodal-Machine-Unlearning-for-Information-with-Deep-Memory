...
def main(args, config):
    ...
    train_dataset, val_dataset, test_dataset, unlearning_val_dataset, remain_dataset = create_dataset('caption_flickr_kul', config)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./unlearning_configs/train_configs/caption_flickr_kul.yaml')
    parser.add_argument('--output_dir', default='./output/Caption_flickr_kul_dbi')
