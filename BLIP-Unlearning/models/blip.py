...
class BLIP_Decoder(nn.Module):
    ...
    def forward(self, image, caption):
        ...
        text = self.tokenizer(caption, padding='longest', truncation=True, max_length=60, return_tensors="pt").to(
            image.device)
    ...
    def generate(self, image, sample=False, num_beams=3, max_length=30, min_length=10, top_p=0.9,
        ...
        input_ids = self.tokenizer(prompt, return_tensors="pt").input_ids.to(image.device)  # tokenize prompt
