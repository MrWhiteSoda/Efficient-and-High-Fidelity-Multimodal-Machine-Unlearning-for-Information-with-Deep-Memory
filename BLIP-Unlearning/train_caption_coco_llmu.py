...
def compute_logits(model, image, caption, device, config):
    ...
    decoder_targets[:, :model.module.prompt_length] = -100  # 将前prompt_length设置为-100
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./unlearning_configs/train_configs/caption_coco_llmu.yaml')
    parser.add_argument('--output_dir', default='./output/Caption_coco_llmu_resume')
