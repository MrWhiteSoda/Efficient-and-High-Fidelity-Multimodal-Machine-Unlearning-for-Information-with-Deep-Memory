...
MISMATCH="../data/vqa/ShareGPT4V/coco_data_100_mismatch.json"
...
CUDA_VISIBLE_DEVICES=2,3 torchrun $DISTRIBUTED_ARGS finetune_sensitive_multidelete.py  \
    ...
    --max_steps 125 \
    --eval_steps 25 \
    --output_dir ../output/minicpmv_sensitive_fiofp_multidelete \
    --logging_dir ../output/minicpmv_sensitive_fiofp_multidelete \
