...
DATA="../data/test_data/training_data.json"
...
CUDA_VISIBLE_DEVICES=1 torchrun $DISTRIBUTED_ARGS finetune.py  \
    ...
    --max_slice_nums 9 \
    --max_steps 10 \
    --output_dir ../output/output_minicpmv_test \
    --logging_dir ../output/output_minicpmv_test \
