...
from dataset import SupervisedDataset, SupervisedDatasetText, MultiDeleteDataset, multidelete_data_collator, SupervisedDatasetForMulti
from trainer_sensitive_multidelete import CPMTrainer
...
def make_supervised_data_module(
    ...
    unlearning_dataset = SupervisedDatasetForMulti(
        unlearning_json,
        transform,
        tokenizer,
    ...
    unlearning_text_dataset = SupervisedDatasetText(
        unlearning_json,
        tokenizer,
        llm_type=llm_type,
        max_length=max_length,
    ...
    match_json = json.load(open(data_args.match_path, "r"))
    ...
    train_dataset = MultiDeleteDataset(unlearning_dataset, unlearning_text_dataset, mismatch_dataset, match_dataset)
...
def train():
    ...
    data_module = make_supervised_data_module(
        ...
        data_collator=multidelete_data_collator,
        slice_config=slice_config,
        llm_type=llm_type,
