...
DATA="../data/vqa/FIOFP/fci_foi_D_r.json"
EVAL_DATA="../data/vqa/FIOFP/fci_foi_D_r.json"
...
CUDA_VISIBLE_DEVICES=2,3 torchrun $DISTRIBUTED_ARGS finetune_sensitive_hard.py  \
    ...
    --max_steps 70 \
    --eval_steps 7 \
    --output_dir ../output/minicpmv_sensitive_ \
    --logging_dir ../output/minicpmv_sensitive_ \
