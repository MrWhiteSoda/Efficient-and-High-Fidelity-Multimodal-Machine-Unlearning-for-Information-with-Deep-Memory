...
CUDA_VISIBLE_DEVICES=2,3 torchrun $DISTRIBUTED_ARGS finetune_sensitive_llmu.py  \
    ...
    --max_steps 125 \
    --eval_steps 25 \
    --output_dir ../output/minicpmv_sensitive_fiofp_llmu \
    --logging_dir ../output/minicpmv_sensitive_fiofp_llmu \
