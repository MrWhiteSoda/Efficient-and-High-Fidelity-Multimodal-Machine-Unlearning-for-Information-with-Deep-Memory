...
from dataset import SupervisedDataset, data_collator, SupervisedDatasetHard, data_collator_hard, HardDataset
from trainer_sensitive_hard import CPMTrainer
...
def make_supervised_data_module(
    ...
    train_dataset = SupervisedDatasetHard(
        train_json,
        transform,
        tokenizer,
